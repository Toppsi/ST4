...
\section{Konklusion}
Pilotforsøget har det formål at undersøge aktiviteterne gang, løb og cykling. Igennem disse aktiviteter blev data opsamlet og herefter behandlet. Pilotforsøget indholdte metoder hvorpå sikring af dataets oprigtighed var tilstede. Både igennem kalibrering samt baselinemålinger, kan det konkluderes at målingerne Shimmer har foretaget er af oprigtig karakter. Data konkluderes dermed at afspejle repræsentative signaler fra de omtalte aktiviteter. \\
Behandlingen af dataene medførte at placering A, for dette projekts formål, blev vurderet som den optimale placering. En placering udfor den laterale malleous bør kunne opfylde kravene vedrørende placeringen af aktivitetsmåleren. Aktiviteterne gang, løb og cykling blev behandlet således at en mulig adskillelse heraf blev muliggjort. Det konkluderes med baggrund i behandlingen, at signalerne er mulige at adskille, hvoraf algoritmedesign er muligt. Resultatet af behandlingen af gang, løb og cykling, medførte ydermere at det endelige system skal benytte et accelerometer med et arbejdsområde på $\pm 16 g$, et gyroskop med et arbejdsområde der er væsentligt større end 320 dps, samt samples med henholdsvis 450 Hz og 60 Hz.
