...
For hver akse udregnes den gennemsnitlige værdi for henholdsvis den positive- og negative akse og sammenholdes med $\pm 1$g. Dermed bestemmes blev den procentmæssige afvigelse fra tyngdeaccelerationen. Resultatet heraf ses i \tabref{fig:akser_pilot}. Kalibreringen foretages for at sikre, at et offset ikke er til stede. 
\begin{table}[H]
	\centering
...
\begin{table}[H]
	...
	\end{tabular}
	\caption{I tabellen ses de gennemsnitlige baselineresultater fra accelerometerets y-akse for gang.}
...
\begin{table}[H]
	...
	\begin{tabular}{cccc}
		...
		F4 & 0,97 & 0,99 & 0,95 \\ \hline
	\end{tabular}
	\caption{I tabellen ses de gennemsnitlige baselineresultater fra accelerometerets y-akse for løb.}
	\label{fig:Ap_baselineloeb}
\end{table}\vspace{-0.45cm}

Ved cykling benyttes gyroskopets data, da cykling detekteres som en roterende bevægelse omkring z-aksen, hvor baselineresultaterne bør ligge omkring nul.
\begin{table}[H]
	\centering
	\begin{tabular}{cccc}
		\hline
	...
	\end{tabular}
	\caption{I tabellen ses de gennemsnitlige baselineresultater fra gyroskopets z-akse for cykling.}
