...
Resultatet af at cykling skal detekteres som en roterende bevægelse omkring z-aksen, benyttes gyroskopets data hertil. Enheden af dataet heraf er grader per sekund (dps), og dermed bør baselineresultaterne befinde sig omkring nul.
\begin{table}[H]
	\centering
	\begin{tabular}{cccc}
		\hline
...
Resultaterne fra baselinemålingerne vedrørende cykling befinder sig som forventet omkring nul, hvilket er et resultat af at Shimmer ikke er blevet påvirket i z-aksen i nogen væsentlig grad, da benet ikke bevæges. Resultaterne af disse målinger indikerer altså Shimmer har optaget data som stemmer overens med antagelsen om den tilnærmelsesvise påvirkning på 0 dps. 
...
\subsection{Frekvensindhold}
Databehandlingen af frekvensindholdet fra gang og løb medførte at det største frekvensspektrum befandt sig mellem 0 og 45Hz. Dette bevirker at det endelige systems samplingsfrekvens kan bestemmes. I følge Nyquist skal samplingsfrekvensen være dobbelt så stor som signalets maksimale frekvens. Dette er en teoretisk værdi, og i praksis skal samplingsfrekvensen være 20 gange større. \citep{} \\
