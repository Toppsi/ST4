...
%
%Detektere(registrere og adskille) gængse aktiviteter - gang, løb og cykling
%Registrere intensiteten af en given aktivitet 
%Monteres uden gene
	%Videresende information trådløst (gennem bluetooth) (overførslen skal være trådløs)
	%Systemet skal være batteridrevet
%Elektrisk sikkert
%De behandlede data/signaler skal kunne visualiseres på en ekstern enhed
	%Kunne optage og visualisere al daglig aktivitet
%Skal være en motiverende faktor for målgruppen
