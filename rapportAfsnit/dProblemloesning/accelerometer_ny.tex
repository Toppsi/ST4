...
Et accelerometer er et elektromekanisk apparat som anvendes til at måle accelerationskræfter, hvilket er ændringer i hastighed og position.\citep{Goodrich2013,TittertonWeston2004}. Enheden måles i meter per sekund i anden($m/s^2$) eller i g-kræfter (g).\fxnote{En g-kraft på jorden svarer til tyngdekræften på 9,8 $m/s^2$ , men varierer med elevation.}\citep{Sparkfun,TittertonWeston2004}
...
Der findes accelerometre som måler i en, to eller tre akser. For at opnå det fulde udbytte af et accelerometer, bør der benyttes et tre-akse accelerometer, eller tre single-akse accelerometre, som ofte placeres vinkelret på hinanden.\citep{TittertonWeston2004}} 

Accelerometre benyttes enten i en åben eller lukket kreds. I en åben kreds fastholdes den indre masse til et nulpunkt ved af være spændt mellem to fjedre. Ved acceleration af kapslen bevæges den indre masse væk fra nulpunktet, hvor ændringen for et single-akse accelerometer vil være proportional med kraften der har påvirket systemet. I en lukket kreds fastholdes den indre masse til en nulpunkt ved hjælp af magnetiske kræfter. Oftest er der påmonteret spoler på den indre masse, hvormed megnetfeltet forstærkes. Det er muligt at foretage mere præcise målinger omkring nulpunktet end ved ændringerne. Accelerometeret med den åbne kreds er mere præcis end det med den lukkede kreds. 
