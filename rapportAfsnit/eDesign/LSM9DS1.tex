...
\subsection{Test}
ICen testes med henblik på at undersøge ICens senorer og deres funktionalitet samt tilhørende tilladte afvigelser opstillet i henholdsvis \secref{krav:acc} og \secref{krav:gyro}. Kravene til accelerometeret er som følger;
