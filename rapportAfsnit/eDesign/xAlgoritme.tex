...
Afslutningsvis vil signalet blive filtreret med et moving average filter som udglatter signalet, hvilket resulterer i at små udslag i signalet ikke opfattes, og signalets hælnedslag vil være pænt og tydeligt. \\
...
\textbf{Ovenstående figur repræsenterer algoritmen for detektering og adskilles af gang og løb. Hvis løb detekteres skal en counter starte og først stoppe når cykling ikke længere detekteres. Når counteren stopper gemmes varigheden af counteren i et array tilhørende udført cykling. Hvis cykling ikke detekteres skal gyroskopet gå i LPM i 10 sekunder før algoritmen køres igen. 
} 

\textbf{Ovenstående forklaring til figur er ikke færdig.!!!}
