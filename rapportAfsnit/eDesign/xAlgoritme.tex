...
\subsubsection{Gang og løb}
Forud for at tærskelværdierne fastsættes og benyttes til at detekterer aktiviteterne gang, løb og cykling, signalbehandles accelerometerets data. Igennem design blev det valgt at signalet først skal filtreres med et elliptisk båndpasfilter. Dette blev implementeret på MCU'en som et IIR filter, med filterkoefficienter udregnet gennem MATLAB. 
