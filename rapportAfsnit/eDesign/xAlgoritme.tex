...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.8]{figures/cDesign/signalbehandling_psoc.png}
...
Det behandlede output er data som er repræsentativt for hvordan PSoC vil behandle data når det endelige system er færdigt. Dette er tilfældet da det er data fra pilotforsøget, som er blevet behandlet igennem PSoC. Data fra pilotforsøget er for alle forsøgspersoner blevet behandlet med ovenstående signalbehandling med henblik på fastsættelse af tærskelværdier. 
