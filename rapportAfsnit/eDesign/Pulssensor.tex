...
\begin{tabular}{ccc}
	\hline
	\rowcolor[HTML]{C0C0C0} 
	Gennemsnitlig puls LoggerPro [BPM] & Gennemsnitlig puls algoritme [BPM] & Afvigelse [\%] \\ \hline
	60 & 64,9 & 8,15 \\ \hline
\end{tabular}
}
