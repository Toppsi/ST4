...
Spændingsforsyningen overholder dermed kravet om, at levere en spænding til MCUen i intervallet 1,7-5,5~V. Hvorvidt spændingsforsyningen kan levere den pågældende spænding i dette tidsinterval undersøges i \secref{sec:samlet_system}. Det samlede system skal være funktionelt og komplet før endtest heraf kan fortages.