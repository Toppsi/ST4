...
\begin{table}[H]
	...
	\begin{tabular}{cccc}
		...
		Indstillet amplitude [Vpp] & \begin{tabular}[c]{@{}c@{}}Målt amplitude fra \\ oscilloskop [Vpp]\end{tabular} & \begin{tabular}[c]{@{}c@{}}Målt amplitude fra \\ MCU ADC [Vpp]\end{tabular} & \begin{tabular}[c]{@{}c@{}}Afvigelse [\%]\end{tabular} \\ \hline
