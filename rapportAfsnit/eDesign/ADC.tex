...
\end{tabular}
	\caption{I tabellen ses størrelsen af det genererede signal, som sendes ind i MCUen. Testen viser en afvigelse på 0,2\% fra det genererede signal til det konverterede signal.}
	\label{tab:ADC_test}
