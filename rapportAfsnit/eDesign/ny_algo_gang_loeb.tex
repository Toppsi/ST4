\section{Algoritme til detektering af gang og løb}
...
\subsection{Test}
Algoritmen til detektion og adskillelse af gang og løb testes for følgende krav fra \secref{krav_algoritme}:
\begin{itemize}
